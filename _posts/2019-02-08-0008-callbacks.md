...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/gtkDcoding/images/screenshots/002_button/button_06.png" alt="Current example output">
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/gtkDcoding/images/screenshots/002_button/button_06_term.png" alt="Current example terminal output">
...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img2" src="/gtkDcoding/images/screenshots/002_button/button_07.png" alt="Current example output">								<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img3" src="/gtkDcoding/images/screenshots/002_button/button_07_term.png" alt="Current example terminal output"> 							<!-- img#, filename -->
